...
const sampleQuestions = [
  ...
  // Reading - Hard
  {
    question_text: "Read the passage and answer: 'John likes to read books in his free time. He has a large collection of mystery novels.' What does John like to do?",
    question_type: "multiple_choice",
  ...
  {
    question_text: "Based on the text: 'The weather is sunny today. It's a perfect day for a picnic.' What is the weather like?",
    question_type: "fill_blank",
    difficulty_level: "hard",
    category: "reading",
