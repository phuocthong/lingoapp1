...
export const userExists = (email: string, username: string): { exists: boolean; field?: string } => {
...
export const calculateXP = (difficulty: string, isCorrect: boolean, timeTaken: number, maxTime: number = 30): number => {
