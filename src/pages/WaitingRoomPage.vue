      ...
      <div class="nav-container">
        <div class="logo-section">
          <div class="logo-icon">
            ...
            >
              ...
              />
              <path
                d="M18.2021 8H6.20215C5.09758 8 4.20215 8.89543 4.20215 10V18C4.20215 19.1046 5.09758 20 6.20215 20H18.2021C19.3067 20 20.2021 19.1046 20.2021 18V10C20.2021 8.89543 19.3067 8 18.2021 8Z"
                stroke="black"
                stroke-width="2"
                stroke-linecap="round"
                stroke-linejoin="round"
        ...
        <div class="user-section">
            ...
            <div class="stat-item">
              ...
              >
                <g clip-path="url(#clip0_154_988)">
                  <path
                    d="M4.00163 6.00008H3.00163C2.5596 6.00008 2.13568 5.82449 1.82312 5.51193C1.51056 5.19937 1.33496 4.77544 1.33496 4.33341C1.33496 3.89139 1.51056 3.46746 1.82312 3.1549C2.13568 2.84234 2.5596 2.66675 3.00163 2.66675H4.00163"
                    stroke="#6B7280"
                    stroke-width="2"
                    stroke-linecap="round"
                    stroke-linejoin="round"
                  />
                  <path
                    d="M12.002 6.00008H13.002C13.444 6.00008 13.8679 5.82449 14.1805 5.51193C14.493 5.19937 14.6686 4.77544 14.6686 4.33341C14.6686 3.89139 14.493 3.46746 14.1805 3.1549C13.8679 2.84234 13.444 2.66675 13.002 2.66675H12.002"
                    stroke="#6B7280"
                    stroke-width="2"
                    stroke-linecap="round"
                    stroke-linejoin="round"
                  ...
                  />
                  <path
                    d="M6.66895 9.77344V11.3334C6.66895 11.7001 6.35561 11.9868 6.02228 12.1401C5.23561 12.5001 4.66895 13.4934 4.66895 14.6668"
                    stroke="#6B7280"
                    stroke-width="2"
                    stroke-linecap="round"
                    stroke-linejoin="round"
                  />
                  <path
                    d="M9.33496 9.77344V11.3334C9.33496 11.7001 9.64829 11.9868 9.98163 12.1401C10.7683 12.5001 11.335 13.4934 11.335 14.6668"
                    stroke="#6B7280"
                    stroke-width="2"
                    stroke-linecap="round"
                    stroke-linejoin="round"
                  />
                  <path
                    d="M12.002 1.33325H4.00195V5.99992C4.00195 7.06078 4.42338 8.0782 5.17353 8.82835C5.92367 9.57849 6.94109 9.99992 8.00195 9.99992C9.06282 9.99992 10.0802 9.57849 10.8304 8.82835C11.5805 8.0782 12.002 7.06078 12.002 5.99992V1.33325Z"
                    stroke="#6B7280"
                    stroke-width="2"
                    stroke-linecap="round"
                    stroke-linejoin="round"
          ...
          <button class="logout-btn">
            ...
            >
              <path
                d="M6.00195 14H3.33529C2.98166 14 2.64253 13.8595 2.39248 13.6095C2.14243 13.3594 2.00195 13.0203 2.00195 12.6667V3.33333C2.00195 2.97971 2.14243 2.64057 2.39248 2.39052C2.64253 2.14048 2.98166 2 3.33529 2H6.00195"
                stroke="black"
                stroke-width="2"
                stroke-linecap="round"
                stroke-linejoin="round"
              />
              <path
                d="M10.6689 11.3334L14.0023 8.00008L10.6689 4.66675"
                stroke="black"
                stroke-width="2"
                stroke-linecap="round"
                stroke-linejoin="round"
          ...
          <div class="participants-section">
            <div class="section-header">
              <div class="section-title-container">
                ...
                >
                  <path
                    d="M15.2708 20.05V18.2167C15.2708 17.2443 14.8845 16.3116 14.1969 15.624C13.5093 14.9364 12.5766 14.55 11.6042 14.55H6.10417C5.13171 14.55 4.19908 14.9364 3.51144 15.624C2.82381 16.3116 2.4375 17.2443 2.4375 18.2167V20.05"
                    stroke="#020817"
                    stroke-width="2"
                    stroke-linecap="round"
                    stroke-linejoin="round"
                  />
                  <path
                    d="M8.85417 10.8834C10.8792 10.8834 12.5208 9.24176 12.5208 7.21672C12.5208 5.19167 10.8792 3.55005 8.85417 3.55005C6.82912 3.55005 5.1875 5.19167 5.1875 7.21672C5.1875 9.24176 6.82912 10.8834 8.85417 10.8834Z"
                    stroke="#020817"
                    stroke-width="2"
                    stroke-linecap="round"
                    stroke-linejoin="round"
                  />
                  <path
                    d="M20.7715 20.05V18.2167C20.7709 17.4043 20.5005 16.6151 20.0027 15.973C19.505 15.3309 18.8081 14.8723 18.0215 14.6692"
                    stroke="#020817"
                    stroke-width="2"
                    stroke-linecap="round"
                    stroke-linejoin="round"
                  />
                  <path
                    d="M15.2715 3.66919C16.0602 3.87113 16.7593 4.32983 17.2585 4.97297C17.7577 5.61612 18.0287 6.40712 18.0287 7.22127C18.0287 8.03543 17.7577 8.82643 17.2585 9.46957C16.7593 10.1127 16.0602 10.5714 15.2715 10.7734"
                    stroke="#020817"
                    stroke-width="2"
                    stroke-linecap="round"
                    stroke-linejoin="round"
                ...
                <h3 class="section-title">
                  Người tham gia ({{ participants }}/{{ maxParticipants }})
                </h3>
              </div>
